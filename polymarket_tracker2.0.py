...
def main(wallet_addresses=None, skip_leaderboard=False, top_volume=False, 
    ...
    if not wallet_addresses:
        ...
        print("\nUsage examples:")
        print("  One-time check:  python polymarket_tracker.py --wallets 0xADDRESS")
        print("  Monitor mode:    python polymarket_tracker.py --wallets 0xADDRESS --monitor --interval 30")
        return
